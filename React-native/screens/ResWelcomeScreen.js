    ...
    >
      <ScrollView>
        <View className="flex-row justify-center mt-24">
          <Text className="text-purple-500 font-bold text-2xl text-center">
            Sign Up to get your best experience
          </Text>
        </View>
        ...
        <View className="space-y-4">
          <TouchableOpacity
            ...
            style={{ borderRadius: 90, marginTop: 150 }}
          >
            <Text className="text-xl text-center text-black">Sign Up</Text>
          </TouchableOpacity>
